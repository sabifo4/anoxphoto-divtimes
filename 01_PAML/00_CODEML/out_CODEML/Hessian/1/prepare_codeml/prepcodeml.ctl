          seed = -1
       seqfile = /data/scratch/btx126/anoxphoto/alignments/ortho57_aln.phy
      treefile = /data/scratch/btx126/anoxphoto/trees/uncalibrated/anoxphoto_uncalib.tree
      mcmcfile = mcmc.txt
       outfile = out.txt
    ...
    aaRatefile = /data/scratch/btx126/anoxphoto/control_files/lg.dat   * Path to the file with the LG matrix
